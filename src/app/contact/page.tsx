              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="space-y-5">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-green-500 text-white font-semibold py-3.5 px-6 rounded-xl transition-all duration-300 hover:bg-green-600 hover:shadow-lg hover:scale-[1.02] flex items-center justify-center gap-2"
                    >
