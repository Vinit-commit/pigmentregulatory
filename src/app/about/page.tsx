        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimateOnScroll stagger className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: "REACH Compliance", desc: "EU market regulatory requirements", icon: "M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5a17.92 17.92 0 0 1-8.716-2.247m0 0A9 9 0 0 1 3 12c0-1.47.353-2.856.978-4.082" },
      ...
      <section className="bg-surface py-16 md:py-20">
        <AnimateOnScroll animation="fade-up" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-light text-base sm:text-lg leading-relaxed text-center mb-6">
            ...
            the credential. The most respected names in this space all started
            the same way: domain experts turning deep industry knowledge into
